...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-dark mb-0">Subjects</h6>
        </nav>
          ...
          <div class="card mb-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-4">
              <div class="d-flex justify-content-between bg-gradient-primary shadow-primary border-radius-lg p-3">
                <h6 class="text-white ps-3 pt-2 text-uppercase">Subjects List</h6>
            ...
            <div class="card-body px-0 pt-3 pb-2">
              <div class="table-responsive p-0">
                <table class="align-items-center mb-0 w-100 d-block d-md-table text-sm">
                  ...
                  <tbody>
                    <?php
                    $query = "SELECT subject.*, class.clname FROM subject inner join class ON subject.cid = class.cid";
  ...
  <div class="modal fade" id="form" tabdashboard="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="../includes/subdata.php" method="POST" enctype="multipart/form-data"
  ...
  <script>
    const formValidate = () => {
      ...
      const cls = document.getElementById('classs');
      if (name.value == "") {
