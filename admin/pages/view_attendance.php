                            ...
                            <div class="card-body px-0 pt-3 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="align-items-center w-100 d-block d-md-table text-sm">
                                        <thead>
                                            <tr>
                                                <th class="text-center text-uppercase text-secondary font-weight-bolder opacity-7 nowrap "
                                                    style="width: 15%;">
                                                    Roll No</th>
                                                <th class="text-center text-uppercase text-secondary font-weight-bolder opacity-7 ps-2 nowrap "
                                                    style="width: 15%;">
                                                    Student Name</th>
                                                <th class="text-center text-uppercase text-secondary font-weight-bolder opacity-7 ps-2 th-sm nowrap "
                                                    style="width: 15%;">
                                                    Present</th>
                                            </tr>
                                        </thead>
