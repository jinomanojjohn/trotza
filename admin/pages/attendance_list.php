            ...
            <div class="card-body px-0 pt-3 pb-2">
              <div class="table-responsive p-0">
                <table class="align-items-center mb-0 w-100 d-block d-md-table text-sm">
                  ...
                  <tbody>
                    <?php
                    $query = "SELECT am.aid,am.adate,am.class,fd.name,cl.clname FROM attendance_master am inner join faculty_data fd on am.fid=fd.fid inner join class cl on am.class=cl.cid inner join login on am.fid=login.id where login.type='faculty' or login.type='admin'";
                    if($_SESSION['UserType']=='faculty')
                    {
                      $query = "SELECT am.aid,am.adate,am.class,fd.name,cl.clname FROM attendance_master am inner join faculty_data fd on am.fid=fd.fid inner join class cl on am.class=cl.cid where fd.fid={$_SESSION['LoginTeacher']}";
                    }
