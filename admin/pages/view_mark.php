                        ...
                        <div class="card mb-4">
                            <div class="card-header p-0 position-relative mt-n4">
                                <div class="d-flex justify-content-between bg-gradient-primary shadow-primary border-radius-lg p-3">
                                    ...
                                    <h6 class="text-white ps-3 pt-2 text-uppercase">Class-<?php echo $classname?></h6>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr style="background-color: #ddd;">
                                                    ...
                                                    <?php
                                                        $sid = $row['sid'];
                                                        $query1 = "SELECT * from mark_subchild ms inner join mark_child mc on mc.mcid=ms.mcid inner join subject s on s.subid=ms.subject where mc.sid=$sid";
                                            ...
                                            ?>
                                                <td class="align-middle text-center nowrap font-weight-bolder mb-0  ">
                                                    ...
                                                    <i class="fas fa-pencil-alt text-dark me-2 cursor-pointer" data-toggle="modal" data-target="#form" onclick="setData(<?php echo $row1['msid'] ?>,<?php echo $row1['mark'] ?>,'<?php echo $row1['subname'] ?>')"></i>
                                                </td>
