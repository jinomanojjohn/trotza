        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-dark mb-0">Marks</h6>
                </nav>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-4">
                            <div
                                ...
                                <h6 class="text-white ps-3 pt-2 text-uppercase">Mark Lists</h6>
                                <button class="btn bg-gradient-dark m-0 toast-btn" type="button" data-toggle="modal"
                                    data-target="#form"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New Mark
                                    List</button>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    <h5 class="modal-title" id="exampleModalLabel">Add New Mark List</h5>
                ...
                <form action="add_mark.php" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="atdate" name="dt"
