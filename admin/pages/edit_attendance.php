                        ...
                        <div class="card mb-4">
                            <div class="card-header p-0 position-relative mt-n4">
                                <div class="d-flex justify-content-between bg-gradient-primary shadow-primary border-radius-lg p-3">
                                    <h6 class="text-white ps-3 pt-2 text-uppercase">Edit Attendance</h6>
                                ...
                                <div class="table-responsive p-0">
                                    <table class="align-items-center w-100 d-block d-md-table text-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <input type="hidden" value="<?php echo $mid?>" name="aid">
                                            <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <input class="bg-success" type="checkbox" name="<?php echo $row['acid'] ?>" <?php if($row['status'] == 1) echo 'checked' ?>>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
